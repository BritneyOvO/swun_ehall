...
西南民族大学 **学生** Android 客户端（Jetpack Compose + [MIUIX](https://github.com/compose-miuix-ui/miuix)）。用学校统一身份认证（学号 + 密码）登录后，在本地查看课表、成绩、学分、考试，并使用课堂考勤、一卡通、场馆预约和公寓打卡。
